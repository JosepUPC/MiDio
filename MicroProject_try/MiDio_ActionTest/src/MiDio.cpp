...
void PinCheck(){
  ...
  digitalWrite(LED1_PIN,swtich1_currentState);
  digitalWrite(LED2_PIN,swtich2_currentState);
  digitalWrite(LED3_PIN,swtich3_currentState);
  digitalWrite(LED4_PIN,swtich4_currentState);
}
